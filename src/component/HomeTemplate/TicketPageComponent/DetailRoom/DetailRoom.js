        ...
        <Card className={classes.card}>
          <CardHeader
            avatar={
              <Avatar
                aria-label="recipe"
                src={detailRoom?.thongTinPhim?.hinhAnh}
              />
            }
            title={detailRoom?.thongTinPhim?.tenCumRap}
            subheader={`${detailRoom?.thongTinPhim?.ngayChieu} - ${detailRoom?.thongTinPhim?.gioChieu} - ${detailRoom?.thongTinPhim?.tenRap}`}
          />
        </Card>
        <Typography className={classes.time}>
          <span>Thời gian đặt ghế</span>
          <br />
